...
<div >
   <p class="big_title">Call for Student Volunteers<div class="floatRight"><!--span class="studentvolunteers"></span--></div></p>
    ...
    <p>
       Volunteering for VR 2026 is also an opportunity to gain academic service experience—an often-critical component of post graduate work—and valuable experience for future scientific event organization.
    </p>
    <p>
       We look forward to receiving your application for IEEE VR 2026!
    </p>
    ...
    <p>
        ...
        <ul>
            <li>An accepted publication/presentation at VR 2026.</li>
            ...
            <li>Students from underrepresented groups are especially encouraged to apply.
</li>
        </ul>
    </p>    
   ...
   <br/>* Selected student volunteers will be able to register through the participant registration system (a free registration code will be provided). For those who require a visa, an invitation letter will be issued.</p>
    ...
    <p>
        ...
        <p>Contact: <a target="_blank" href="mailto:studentvolunteers2026@ieeevr.org">studentvolunteers2026@ieeevr.org</a>
    </p>
