...
<script>
function handleVideoToggle(detailsElement, videoId) {
    var container = detailsElement.querySelector('.iframe-container');
    
    if (detailsElement.open) {
        // Video 탭이 열릴 때 iframe 삽입 (지연 로딩) 및 표시
        ...
        // Video 탭이 닫힐 때 백그라운드 소리 방지 및 메모리 확보를 위해 iframe 완전히 제거
        container.innerHTML = '';
