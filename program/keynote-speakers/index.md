...
<div class="ks-container">
  ...
  <div class="ks-list-item"> <img src="/2026/assets/images/k_sp_02.png" class="ks-thumb" alt="Dr. Albert “Skip” Rizzo">
    <div class="ks-info">
      ...
      <div class="affiliation">Monday, March 23, 10:00-11:00 / Auditorium</div>
    </div>
  ...
  <div class="ks-list-item"> <img src="/2026/assets/images/k_sp_01.png" class="ks-thumb" alt="Dr. Mar Gonzalez-Franco">
    <div class="ks-info">
      ...
      <div class="affiliation">Tuesday, March 24, 10:00-11:00 / Auditorium</div>
    </div>
  ...
  <div class="ks-list-item"> <img src="/2026/assets/images/k_sp_03.png" class="ks-thumb" alt="Tomasz Bednarz, NVIDIA">
    <div class="ks-info">
      ...
      <div class="affiliation">Wednesday, March 25, 10:00-11:00 / Auditorium</div>
    </div>
...
<div id="modal1" class="ks-modal">
  <div class="ks-modal-content">
    <div class="ks-modal-header-bar"> <span style="font-weight: bold; color: #666;">Speaker Detail</span> <span class="ks-close" onClick="closeKsModal('modal1')">&times;</span> </div>
    <div class="ks-modal-scroll-area">
      <div class="ks-modal-profile"> <img src="/2026/assets/images/k_sp_01.png" class="ks-modal-photo">
  ...
  <div class="ks-modal-content">
    ...
    <div class="ks-modal-scroll-area">
      <div class="ks-modal-profile"> <img src="/2026/assets/images/k_sp_03.png" class="ks-modal-photo">
        <h2 class="ks-modal-name">Dr. Tomasz Bednarz</h2>
      ...
      <div class="ks-section-title">Abstract</div>
      <div class="ks-text-content">Physical AI is here. See how world foundation models are supercharging digital twins, robots, self-driving cars & vision agents. By unifying large-scale world models for reasoning, prediction, and synthetic data generation with high-fidelity simulation and Vis / XR testbeds, developers can safely explore vast scenario spaces and continuously improve real-world deployments. Case studies spanning mobile robots, manipulators, and video AI agents illustrate real‑to‑virtual‑to‑real workflows where digital twins act as living systems that accelerate innovation, enhance safety, and enable more capable and trustworthy embodied AI in complex environments.</div>
      <div class="ks-section-title">Biography</div>
      <div class="ks-text-content">Tomasz Bednarz is Director of Strategic Researcher Engagement at NVIDIA, where he works with leading scientists and institutions on advanced, compute‑intensive research. He previously led visualization research at the Expanded Perception and Interaction Centre at UNSW and at CSIRO’s Data61, contributing to projects in immersive visualization, human–computer interaction, simulation, and AI. Tomasz holds degrees in physics and applied computer science from AGH University of Science and Technology, a PhD in interdisciplinary engineering from Kyushu University, and an MBA in technology from AGSM at UNSW. He also chairs the SIGGRAPH Asia Conference Advisory Group, helping guide the future of the computer graphics and interactive techniques community.<br/>
       </div>
    </div>
  </div>
</div>
