...
<div>
    ...
    <a href="https://inria.fr/en" target="_blank">
        <img class="conf-icon"  src="/2025/assets/images/sponsors/Inria.png" alt="Inria logo.">
    </a>
    <br><br>
    <!-- Silver -->
    ...
    <div class ="silver">
        ...
        <a href="https://www.interdigital.com/" target="_blank">
            <img class="conf-icon"  src="/2025/assets/images/sponsors/InterDigital2.png" alt="InterDigital logo.">
        </a>        
        </div>
    <br>
        <div>
        <a href="https://about.google/" target="_blank">
            <img class="conf-icon"  src="/2025/assets/images/sponsors/Google.png" alt="Google logo.">
        </a>
        </div>
    </div>
    <div class ="silver">
        <div><p style="margin-right: 10px;margin-left: 10px;">For more than 50 years, InterDigital® has been inventing foundational wireless, video and AI technologies that have become essential to daily life and enable the next generation of connected ecosystems. As a result, InterDigital is a leader in making the connected world we depend on possible.</p>
        </div>
        <div>
        <p style="margin-left: 10px;margin-right: 10px;">Google is the company behind Android XR, an operating system for headsets and glasses that will be available in 2025. <a href="https://www.android.com/xr/">Learn more:</a> Google's mission is to organize the world’s information and make it universally.</p>
        </div>
    </div>
    <!-- Bronze -->
    ...
    <div class="bronze">
        <div>
            <a href="https://www.middlevr.com/2/" target="_blank">
                <img class="conf-icon" src="/2025/assets/images/sponsors/MiddleVR.png" alt="MiddleVR logo.">
            </a>
        </div> 
        <div>
            <a href="https://www.hitlabnz.org/" target="_blank">
                <img class="conf-icon"  src="/2025/assets/images/sponsors/Hit Lab NZ_Bronze.png" alt="HITLab NZ logo.">
            </a>
        </div>
        <div>
            <a href="https://www.immersion.fr/" target="_blank">
                <img class="conf-icon"  src="/2025/assets/images/sponsors/Immersion.png" alt="Immersion logo.">
            </a>
        </div>
    </div>
    <div class="bronze">
        <div>
            <a href="https://www.qualcomm.com/" target="_blank">
                <img class="conf-icon"  src="/2025/assets/images/sponsors/Qualcomm.png" alt="Qualcomm logo.">
            </a>
        </div>
        <div>
            <a href="https://www.huawei.com/en/" target="_blank">
                <img class="conf-icon"  src="/2025/assets/images/sponsors/Huawei.jpg" alt="Huawei logo.">
            </a>
        </div>
        <div>
            <a href="https://www.meta.com/fr/" target="_blank">
                <img class="conf-icon" src="/2025/assets/images/sponsors/realitylabs.png" alt="realitylabs logo.">
            </a>
        </div>
    </div>
    ...
    <div class="supportersfi">
        <div>
            <a href="https://www.afxr.org/page/1756926-accueil" target="_blank">
                <img class="conf-icon" src="/2025/assets/images/sponsors/AFXR.png" alt="AFXR logo.">
            </a>
        </div>
        <div>
            <a href="https://labsticc.fr/en" target="_blank">
                <img class="conf-icon"  src="/2025/assets/images/sponsors/LabSTICC.png" alt="LabSTICC logo.">
            </a>
        </div>
        <div>
            <a href="https://guestxr.eu/" target="_blank">
                <img class="conf-icon"  src="/2025/assets/images/sponsors/GuestXR.png" alt="GuestXR logo.">
            </a>
        </div>
        <div>
            <a href="https://artsetmetiers.fr/en" target="_blank">
                <img class="conf-icon"  src="/2025/assets/images/sponsors/ENSAM.png" alt="ENSAM logo.">
            </a>
        </div>
        <div>
            <a href="https://www.haption.com/" target="_blank">
                <img class="conf-icon"  src="/2025/assets/images/sponsors/Haption.jpg" alt="Haption logo.">
            </a>
        </div>
    </div>    
    <div class="supportersfo">
        <div>
            <a href="https://www.euroxr-association.org/" target="_blank">
                <img class="conf-icon"  src="/2025/assets/images/sponsors/EuroXR.png" alt="EuroXR logo.">
            </a>
        </div>
        <div>
            <a href="https://www.insa-rennes.fr/graduate-school-of-engineering.html" target="_blank">
                <img class="conf-icon"  src="/2025/assets/images/sponsors/INSA.png" alt="INSA logo.">
            </a>
        </div>
        <div>
            <a href="https://www.neurociencies.ub.edu/" target="_blank">
                <img class="conf-icon"  src="/2025/assets/images/sponsors/neurociences2.png" alt="Institut de Neurociencies, Universitat de Barcelona logo.">
            </a>
        </div>
        <div>
            <a href="https://sharespace.eu/" target="_blank">
                <img class="conf-icon" style="width: 80%" src="/2025/assets/images/sponsors/SHARESPACE.jpg" alt="SHARESPACE logo.">
            </a>
        </div>
    </div>    
    <div class="supportersfi">
        ...
        <div>
            <a href="https://www.orange.fr/" target="_blank">
                <img class="conf-icon"  style="width: 80%" src="/2025/assets/images/sponsors/orange.png" alt="orange logo.">
            </a>
        </div>
        <div>
    ...
    <div class="supporterst">
        ...
        <div>
            <a href="https://www.cesi.fr/en/" target="_blank">
                <img class="conf-icon"  src="/2025/assets/images/sponsors/CESI.jpg" alt="CESI logo.">
            </a>
        </div>
        <div>
